// ⚽ Futebol - Match Winner (1X2)
import type { Market, MarketOutcome } from '../../../types/sports';

export interface MatchWinnerMarket extends Market {
  type: 'match_winner';
  outcomes: {
    home: MarketOutcome;
    draw: MarketOutcome;
...
export function createMatchWinnerMarket(
  homeTeam: string,
  awayTeam: string,
  homeOdds: number,
  drawOdds: number,
  ...
  return {
    ...
    description: 'Aposte em quem vencerá o jogo (1X2)',
    sport: 'football',
    priority: 1,
    isLive: false,
    outcomes: {
