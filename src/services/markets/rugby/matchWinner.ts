...
export interface RugbyMatchWinnerMarket extends Market {
  type: 'match_winner';
  outcomes: {
    home: MarketOutcome;
    draw: MarketOutcome;
...
export function createRugbyMatchWinnerMarket(
  homeTeam: string,
  awayTeam: string,
  homeOdds: number,
  drawOdds: number,
  awayOdds: number
): RugbyMatchWinnerMarket {
  return {
    id: `rugby_match_winner_${Date.now()}`,
    type: 'match_winner',
